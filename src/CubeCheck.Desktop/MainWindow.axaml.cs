...
public partial class MainWindow : Window
{
    ...
    void PaintChrome()
    {
        ...
        if (UpdateGlyph != null) UpdateGlyph.Stroke = ThemeHelper.Brush(_colors.Accent);
    ...
    public void ShowUpdateOffer(UpdateOffer offer)
    {
        ...
        ToolTip.SetTip(BtnUpdate, "Доступно обновление " + offer.Version);
    }
    ...
    async void OnApplyUpdate(object? sender, RoutedEventArgs e)
    {
        ...
        ToolTip.SetTip(BtnUpdate, "Загрузка обновления…");
        try
        {
