...
pub const TELEGRAM_URL: &str = "https://telegram.me/cubecheck";

pub const HOLYCHECK_URL: &str = "https://mods.holyworld.me/";

pub const ABOUT_TEXT: &str = r"CubeCheck — проверка компьютера на читы Minecraft.
